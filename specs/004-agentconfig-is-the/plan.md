...
**Structure Decision**: Single project structure for Chrome extension with dedicated config directory for environment handling and build-time processing via Vite plugin.
